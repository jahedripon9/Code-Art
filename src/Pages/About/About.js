...
const About = () => {
    return (
        <div className='lg:my-10 my-10 bg-slate-200  lg:mx-12 mx-10 rounded-lg'>
            <div className='mt-5'>
            ...
            <section class="text-gray-600 body-font mx-12">
                <div class="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
                    ...
                    <img class="object-cover object-center rounded" alt="hero" src="https://i.ibb.co/zhRQH8q/Jahad-Master.jpg"/>
                    </div>
                    ...
                    <p class="mb-4 leading-relaxed text-lg mx-12">I'm a Freelancer Front-End Developer with over 2 years of experience. I'm from Sylhet, Bangladesh. I code and create web elements for amazing people around the world. I like work with new people. New people are new experiences.</p>
                     <a target='_blank' href="https://jahedportfolio.netlify.app/"><button type="button" class="py-2 px-4   mx-1  bg-green-600 hover:bg-green-700 focus:ring-green-500 focus:ring-offset-green-200 text-white w-34 transition ease-in duration-100 text-center text-xm font-bold  shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-full my-2"> My Portfolio</button></a>
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Skills   
                    </h1>
